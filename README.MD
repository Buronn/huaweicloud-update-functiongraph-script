...
This modified README now includes a section detailing how to run the script using Docker Compose. It also mentions that Docker Compose should be installed as an optional requirement.
